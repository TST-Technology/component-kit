...
import SingleLightbox from '../advisor/SingleLightbox';
import VideoPlayer from '../common/VideoPlayer';
import CommentWithLikes from '../advisor/CommentWithLikes';
  ...
  return (
    <div className="mb-3">
      <div className="post-icon mr-3 d-inline-block">
        ...
        <span>125 {messages['advisor.likes']}</span>
      </div>
      ...
      <div className="post-icon mr-3 d-inline-block">
        ...
        <span>6 {messages['advisor.comments-title']}</span>
      </div>
    </div>
  );
};
    ...
    <Card className={className}>
      <CardBody>
        ...
        <InputGroup className="comment-container">
          <Input placeholder={messages['advisor.addComment']} />
          <InputGroupAddon addonType="append">
            <Button color="primary">
              <span className="d-inline-block">{messages['advisor.send']}</span>{' '}
