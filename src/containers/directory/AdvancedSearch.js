    ...
    <Card className="directory-search">
      <CardBody>
        <CardTitle className="text-white">
          <IntlMessages id="directory.advanced-search" />
        </CardTitle>
        <Form className="form-container">
          <FormGroup>
            <label>
              <IntlMessages id="directory.toppings" />
            </label>
            <Select
          ...
          <FormGroup>
            <label>
              <IntlMessages id="directory.type" />
            </label>
            <Select
              components={{ Input: CustomSelectInput }}
              className="react-select"
          ...
          <FormGroup>
            <Label>
              <IntlMessages id="directory.keyword" />
            </Label>
            <Input type="text" placeholder={messages['directory.keyword']} />
          </FormGroup>
          <FormGroup>
            <CustomInput
              type="checkbox"
          ...
          <FormGroup className="text-center">
            <Button color="primary" className="btn-lg mt-3">
              <IntlMessages id="directory.search" />
            </Button>
          </FormGroup>
        </Form>
      </CardBody>
