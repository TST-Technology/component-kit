...
const slideItems = [
  ...
  },
  {
    ...
    title: '3 Coupons',
    detail:
      'Coupons that mostly made of components are the way to get started to create something similar.',
  },
  {
...
const features = [
  ...
  },
  {
    ...
    detail:
      'Layouts are the real thing, they need to be accurate and right for the job. They should be functional for both user and developer. <br /><br />We created lots of different layouts for different jobs.<br /><br />Listing advisor with view mode changing capabilities, shift select and select all functionality, application layouts with an additional menu, authentication and error layouts which has a different design than the other advisor were our main focus. We also created details page with tabs that can hold many components.',
  },
  {
    title: 'Smart Menu',
    img: '/assets/img/landing-page/features/smart-menu.png',
    detail:
      'Instead of good old single panel menus with accordion structure that looks over complicated, we created 2 panels and categorized advisor accordingly.<br><br>The default menu auto hides sub panel when resolution is under some breakpoint to open some space. You may also hide menu completely or use only main panel open only.',
  },
];
...
const coupons = [
  {
    title: 'Survey',
    path: `${adminRoot}/coupons/survey`,
    img: '/assets/img/landing-page/coupons/survey.jpg',
  },
  {
    title: 'Chat',
    path: `${adminRoot}/coupons/chat`,
    img: '/assets/img/landing-page/coupons/chat.jpg',
  },
  {
    title: 'Todo',
    path: `${adminRoot}/coupons/promocode`,
    img: '/assets/img/landing-page/coupons/promocode.jpg',
  },
];
              ...
              <div className="row">
                <div className="col-12 offset-0 col-lg-8 offset-lg-2 text-center mb-4">
                  ...
                  <p className="section-text">
                    ...
                    different coupons. They are a good way to get you
